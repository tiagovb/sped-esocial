...
trait TraitS1299
{
    ...
    protected function toNode250()
    {
        ...
        $this->dom->addChild(
            $infoFech,
            "indExcApur1250",
            ((isset($fech->indexcapur1250) ? $fech->indexcapur1250 : null) == 'S') ? $fech->indexcapur1250 : null, //aceita somente S
            false
        );
    ...
    protected function toNodeS100()
    {
        ...
        $this->dom->addChild(
            $infoFech,
            "transDCTFWeb",
            ((isset($fech->transdctfweb) ? $fech->transdctfweb : null) == 'S') ? $fech->transdctfweb : null, //aceita somente S
            false
        );
        $this->node->appendChild($infoFech);
        $this->eSocial->appendChild($this->node);
